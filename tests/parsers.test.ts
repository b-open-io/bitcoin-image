...
describe('parseImageURL', () => {
  describe('Bitcoin Protocol (b://)', () => {
    test('parses b://txid format', () => {
      const result = parseImageURL('b://6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
    ...
    test('parses b://txid_vout format', () => {
      const result = parseImageURL('b://6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910_3');
      expect(result.protocol).toBe(Protocol.Bitcoin);
      expect(result.txid).toBe('6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
  ...
  describe('Ordinals Protocol (ord://)', () => {
    test('parses ord://txid format', () => {
      const result = parseImageURL('ord://6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
    ...
    test('parses ord://txid_vout format', () => {
      const result = parseImageURL('ord://6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910_2');
      expect(result.protocol).toBe(Protocol.Ordinals);
    ...
    test('parses ord://txid.vout format', () => {
      const result = parseImageURL('ord://6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910.1');
      expect(result.protocol).toBe(Protocol.Ordinals);
  ...
  describe('BitFS Protocol (bitfs://)', () => {
    test('parses bitfs://txid format', () => {
      const result = parseImageURL('bitfs://6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
    ...
    test('parses bitfs://txid.out.vout format', () => {
      const result = parseImageURL('bitfs://6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910.out.3');
      expect(result.protocol).toBe(Protocol.BitFS);
      expect(result.txid).toBe('6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
      expect(result.vout).toBe(3);
      expect(result.isValid).toBe(true);
  ...
  describe('Native format', () => {
    test('parses native txid', () => {
      const result = parseImageURL('6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
    ...
    test('parses native txid_vout', () => {
      const result = parseImageURL('6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910_2');
      expect(result.protocol).toBe(Protocol.Native);
      expect(result.txid).toBe('6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
      expect(result.vout).toBe(2);
      expect(result.isValid).toBe(true);
    ...
    test('parses dot notation txid.vout format', () => {
      const result = parseImageURL('6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910.3');
      expect(result.protocol).toBe(Protocol.Native);
      expect(result.txid).toBe('6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
      expect(result.vout).toBe(3);
      expect(result.isValid).toBe(true);
    ...
    test('parses Bitcoin-style output notation txido0', () => {
      const result = parseImageURL('6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910o1');
      expect(result.protocol).toBe(Protocol.Native);
      expect(result.txid).toBe('6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
      expect(result.vout).toBe(1);
      expect(result.isValid).toBe(true);
    ...
    test('parses Bitcoin-style input notation txidi0', () => {
      const result = parseImageURL('6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910i2');
      expect(result.protocol).toBe(Protocol.Native);
      expect(result.txid).toBe('6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
      expect(result.vout).toBe(2);
      expect(result.isValid).toBe(true);
    ...
    test('does not parse raw format when disabled', () => {
      const result = parseImageURL('6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910', { allowNativeTxid: false });
