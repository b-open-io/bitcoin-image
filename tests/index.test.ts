...
import { ImageProtocols, createImageProtocols, parse, getDisplayUrl } from '../src/index';
...
describe('ImageProtocols', () => {
  ...
  describe('parse', () => {
    test('parses various URL formats', () => {
      ...
      testCases.forEach(({ input, expectedProtocol }) => {
  ...
  describe('getDisplayUrl', () => {
    test('converts b:// URL to display URL', async () => {
      ...
      expect(displayUrl).toBe('https://ordfs.network/6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910_0');
    });
    ...
    test('converts ord:// URL to display URL', async () => {
      ...
      const displayUrl = await imageProtocols.getDisplayUrl(url);
      expect(displayUrl).toBe('https://ordfs.network/6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910_2');
    });
  ...
  describe('batch processing', () => {
    test('processes multiple URLs', async () => {
      ...
      expect(results.get('b://6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910')).toBe('https://ordfs.network/6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910_0');
      expect(results.get('ord://7de94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f911')).toBe('https://ordfs.network/7de94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f911');
  ...
  describe('custom handlers', () => {
    test('uses custom handler', async () => {
      ...
      expect(displayUrl).toBe('custom://6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
    });
    ...
    test('registers handler dynamically', async () => {
      ...
      const url = 'b://6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910';
      const displayUrl = await imageProtocols.getDisplayUrl(url);
      expect(displayUrl).toBe('dynamic://6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
    });
  });
