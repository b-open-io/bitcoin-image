...
describe('Protocol Handlers', () => {
  describe('bitcoinHandler', () => {
    test('handles txid with default vout', () => {
      ...
      expect(result).toBe('https://ordfs.network/6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910_0');
    });
    ...
    test('handles txid with specific vout', () => {
      ...
      expect(result).toBe('https://ordfs.network/6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910_3');
    });
  ...
  describe('ordinalsHandler', () => {
    test('handles txid without vout', () => {
      ...
      expect(result).toBe('https://ordfs.network/6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
    });
    ...
    test('handles txid with vout', () => {
      ...
      expect(result).toBe('https://ordfs.network/6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910_2');
    });
  });
  ...
  describe('bitfsHandler', () => {
    test('handles txid without vout', () => {
      ...
      expect(result).toBe('https://x.bitfs.network/6ce94f75b88a6c24815d480437f4f06ae895afdab8039ddec10748660c29f910');
    });
